...
export default function Category() {
  ...
  useEffect(() => {
    if (cat) document.title = `${t(cat.name)} — ${t(T.brand)}`;
  }, [cat, t]);
  ...
  return (
    <>
      ...
      <section className="relative overflow-hidden border-b border-line bg-surface">
        ...
        <div
          className="absolute -top-20 start-[-6%] h-72 w-72 rounded-full blur-3xl"
        ...
        <div className="container-x relative py-14 md:py-20">
          <Reveal>
            ...
            <p className="mt-2 text-lg font-bold tracking-wide text-muted" dir="ltr">
              {cat.latin} — {cat.name.en.toUpperCase()}
            </p>
      ...
      <section className="border-t border-line bg-surface/70">
        <div className="container-x py-14">
          <p className="mb-6 text-xs font-bold tracking-[0.22em] text-muted uppercase">
            {t(T.otherCats)}
          </p>
